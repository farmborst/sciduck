...
# see https://gist.github.com/renzok/29c9e5744f1dffa392cf
...
exec gosu "${USER}" bash -c "cat /home/$USER/sciduck; echo -e 'Welcome to SciDuck\n\nFor Standard Setup just run:\njupyter-lab --NotebookApp.token=\"password\" '; source /opt/python/venv_python3.7.4/bin/activate; bash"
